...
with open("code_pytorch/hyperparameter_tuning/gru_hyperparameter_tuning.txt", "w") as hyperparameter_tune_file:
...
plt.savefig("code_pytorch/hyperparameter_tuning/gru_hyperparameter_search.png")