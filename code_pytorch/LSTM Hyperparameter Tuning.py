...
with open("code_pytorch/hyperparameter_tuning/lstm_hyperparameter_tuning.txt", "w") as hyperparameter_tune_file:
...
plt.savefig("code_pytorch/hyperparameter_tuning/lstm_hyperparameter_search.png")