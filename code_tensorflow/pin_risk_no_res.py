...
stock_dyn, option_type, int(T * 252), freq_rebal, loss_type, alpha, beta, mu, sigma, strike, nbs_shares, res)
    ...
    with tf.Session() as sess:
        ...
        deltas_tensor, hedging_err_tensor, S_t_tensor, V_t_tensor, A_t_tensor, B_t_tensor, input_t_tensor = model_predict.predict(test_paths, sess,
                                                                                                          epochs)
        deltas_DH, hedging_err_DH = Utils_general.delta_hedge(nbs_point_traj, test_paths, r_borrow, r_lend, mu, sigma,
                                                              S_0, T, alpha, beta, option_type, position_type, strike,
                                                              V_0,
                                                              nbs_shares)
