...
med_res_Bt = t_exp[:,[0,1,4]]
rmse_med_res_Bt = rmse
std_med_res_Bt = std
...
str_res_Bt = t_exp[:,[0,1,4]]
rmse_str_res_Bt = rmse
std_str_res_Bt = std
...
#with open('effect_of_Bt_error', 'wb') as f:
#    pickle.dump([rmse_weak_res_Bt, rmse_med_res_Bt, rmse_str_res_Bt],f)
#    pickle.dump([std_weak_res_Bt, std_med_res_Bt, std_str_res_Bt],f)
