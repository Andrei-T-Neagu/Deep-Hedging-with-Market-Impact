...
#with open('effect_of_T_error', 'wb') as f:
#    pickle.dump([rmse_weak_res_T, rmse_med_res_T, rmse_str_res_T],f)
#    pickle.dump([std_weak_res_T, std_med_res_T, std_str_res_T],f)
