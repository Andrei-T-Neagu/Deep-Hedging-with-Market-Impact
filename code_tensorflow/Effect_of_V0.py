...
med_res_V0 = t_exp[:,[0,1,4]]
rmse_med_res_V0 = rmse
std_med_res_V0 = std
...
#    pickle.dump([rmse_weak_res_V0, rmse_med_res_V0, rmse_str_res_V0],f)
#    pickle.dump([std_weak_res_V0, std_med_res_V0, std_str_res_V0],f)
