...
batch_size = 2000  # {128;256;500;1000}
r_borrow = 0.00
r_lend = 0.00
S_0 = 1000.0
hab = [1000.0, 1000.0]
...
nbs_shares = 1
epochs = 10 #50
train_paths = 20000# used by Alex --> 400000  # juste pour entraînement
test_paths = 1000 # used by Alex -->50000  # juste pour évaluation: out-of-sample performance/résultats pour papier.
lr = 0.001
 ...
 #   print(" ----------------- ")
  #  print(" Global hedging %s results" % (loss_type))
   # print(" ----------------- ")
    ...
    print(" ----------------- ")
    deltas_DH, hedging_err_DH = Utils_general.delta_hedge_res(S_t_HR, r_borrow, r_lend, sigma, T, alpha, beta, option_type, position_type, strike, V_0, nbs_shares)
