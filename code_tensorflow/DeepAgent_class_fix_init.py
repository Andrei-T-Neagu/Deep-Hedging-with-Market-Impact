...
class DeepAgent(object):
    ...
    def __init__(self, nbs_point_traj, batch_size, r_borrow, r_lend, stock_dyn, params_vect, S_0, T, alpha, beta,
        ...
        self.A_0 = 0 * tf.ones(self.batch_size) # Fixed init value #
        self.ha = hab[0] #Resilience parameter, ask part
        self.B_0 = 0 * tf.ones(self.batch_size) # Fixed init value #
        ...
        if (self.position_type == "Long"):
            V_t = -self.V_0 * tf.ones(self.batch_size) # Fixed init value
          ...
          #  if (epoch + 1) % 1 == 0:
            ...
            if (self.loss_epochs[epoch] < loss_best):
                ...
                self.saver.save(sess,
                                r"/home/clarence/UQAM/Research/Global_Hedging_LOB_projet_Fred_Alex/Code_Alexandre/Pycharm_version/Error_fix_random_init_value/%s/models.ckpt" % self.model_name)
